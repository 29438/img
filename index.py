...
def main():
    School_Server_API = {
        'login-url': 'https://authserver.whit.edu.cn/authserver/login?service=https%3A%2F%2Fwhit.campusphere.net%2Fiap%2FloginSuccess%3FsessionToken%3Df6184ab6c4fd47e185ac01a912b3b0e3',
        'host': 'whit.campusphere.net'
    }
    user = {
        'username': USERNAME,
        'password': PASSWORD
